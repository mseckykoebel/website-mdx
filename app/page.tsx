...
function NewsSection() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-8">
      <h2 className="text-xl sm:text-2xl font-bold mb-6">News</h2>
      <ul className="space-y-4">
        <li>
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-lg hover:text-gray-900 transition-colors underline"
          >
...
function WorkSection() {
  return (
    <div className="max-w-4xl mx-auto px-6 mt-6">
      <h2 className="text-xl sm:text-2xl font-bold mb-6">Work</h2>
      ...
      <Accordion type="single" collapsible className="w-full space-y-4">
        ...
        >
          ...
          <AccordionContent>
            <div className="pt-4 pb-2 space-y-4">
              <p>I&apos;m currently the founding engineer at Wizard Perks.</p>
        ...
        >
          ...
          <AccordionContent>
            <div className="pt-4 pb-2 space-y-4">
              <p>I co-founded Pathize Health late in 2022.</p>
          ...
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center gap-3 text-left">
                ...
                <div>
                  <div className="font-semibold">Brinc - Web Developer</div>
                  <div className="text-sm text-gray-500">
          ...
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center gap-3 text-left">
                ...
                <div>
                  <div className="font-semibold">Hurds Family Farm</div>
                  <div className="text-sm text-gray-500">
